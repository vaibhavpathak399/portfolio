      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {projects.map((project, index) => (
            <div
              key={index}
              className="bg-gradient-to-br from-white/10 to-white/5 border border-white/10 rounded-3xl p-8 hover:scale-[1.03] hover:border-blue-500/50 transition duration-300"
            >
